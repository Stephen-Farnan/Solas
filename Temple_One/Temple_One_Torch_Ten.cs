...
public class Temple_One_Torch_Ten : MonoBehaviour
{
    ...
    public bool Interact_With()
    {
        if (!activated)
        {
            ...
            activated = true;
            local_Temple_One_Puzzle_Three.torch_Ten_Is_Lit = true;
            local_Temple_One_Puzzle_Three.Check_Puzzle_Is_Solved(4);

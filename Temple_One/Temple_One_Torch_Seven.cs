...
public class Temple_One_Torch_Seven : MonoBehaviour
{
    ...
    public bool Interact_With()
    {
        if (!activated)
        {
            ...
            activated = true;
            local_Temple_One_Puzzle_Three.torch_Seven_Is_Lit = true;
            local_Temple_One_Puzzle_Three.Check_Puzzle_Is_Solved(1);

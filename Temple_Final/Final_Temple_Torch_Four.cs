...
public class Final_Temple_Torch_Four : MonoBehaviour
{
    ...
    public bool Interact_With()
    {
        if (!activated)
        {
            ...
            activated = true;
            local_Temple_One_Puzzle_Two.torch_Six_Is_Lit = true;
            local_Temple_One_Puzzle_Two.Check_Puzzle_Is_Solved(4);

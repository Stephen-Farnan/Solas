...
public class Final_Temple_Torch_One : MonoBehaviour
{
    ...
    public bool Interact_With()
    {
        if (!activated)
        {
            ...
            activated = true;
            local_Temple_One_Puzzle_Two.torch_Three_Is_Lit = true;
            local_Temple_One_Puzzle_Two.Check_Puzzle_Is_Solved(1);

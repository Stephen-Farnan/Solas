...
public class Final_Temple_Torch_Three : MonoBehaviour
{

    public Final_Temple_Torch_Puzzle local_Temple_One_Puzzle_Two;
    ...
    public bool Interact_With()
    {
        if (!activated)
        {
            ...
            activated = true;
            local_Temple_One_Puzzle_Two.torch_Five_Is_Lit = true;
            local_Temple_One_Puzzle_Two.Check_Puzzle_Is_Solved(3);

...
public class Ice_Temple_Puzzle_Two : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        block_To_Move.GetComponent<Ice_Temple_Block_Script>().puzzleTwo = this;
    }
    ...
    {
        local_Ice_Block_Puzzle_Manager.Check_Puzzle_Two_Is_Solved();
    }
}

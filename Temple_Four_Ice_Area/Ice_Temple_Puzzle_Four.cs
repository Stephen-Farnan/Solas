...
public class Ice_Temple_Puzzle_Four : MonoBehaviour
{
    ...
    bool other_Goals_Are_Pressed = false;

    int goals_Pressed = 0;

    public bool final_Temple = false;
    ...
    private void Start()
    {
        Block_A.GetComponent<Ice_Temple_Block_Script>().puzzleFour = this;
        Block_B.GetComponent<Ice_Temple_Block_Script>().puzzleFour = this;
        if (Block_C != null)
        {
            Block_C.GetComponent<Ice_Temple_Block_Script>().puzzleFour = this;
        }
    ...
    {
        local_Ice_Block_Puzzle_Manager.Check_Puzzle_Four_Is_Solved();
    }

    void Solve_Final_Temple_Puzzle()
    {
        local_Ice_Block_Puzzle_Manager.Final_Temple_Puzzle_Solved();
    }
